  ...
  <el-scrollbar class="scroll">
    <div>
      ...
      <el-menu :collapse="false" text-color="#fff" active-text-color="#fff" style="margin-top: 10px">
        ...
        <el-menu-item @click="router.push({name: 'upgrade'})" index="upgrade"
                      :class="route.meta.name === 'upgrade' ? 'choose-item' : ''">
          <Icon icon="solar:crown-line-duotone" width="21" height="21" />
          <span class="menu-name" style="margin-left: 20px">{{$t('upgradeRole')}}</span>
        </el-menu-item>
