const en = {
    ...
    settings: 'Settings',
    upgradeRole: 'Upgrade',
    upgradeRoleDesc: 'Permanent access; support on Afdian and contact the administrator to upgrade',
    currentRole: 'Current role',
    currentPlan: 'Current plan',
    cannotDowngrade: 'Downgrade unavailable',
    permanentRole: 'Permanent access',
    planHighlights: 'Plan highlights',
    multiDomainFeatureDomains: 'Domains for Genshin Impact, Honkai: Star Rail, Zenless Zone Zero, and Honkai Impact 3rd',
    multiDomainFeatureAccounts: 'Create 1 email address per domain',
    multiDomainFeatureSend: 'Send up to 20 emails per day',
    multiAccountFeatureDomains: 'Domains for Genshin Impact, Honkai: Star Rail, Zenless Zone Zero, and Honkai Impact 3rd',
    multiAccountFeatureAccounts: 'Create up to 10 email addresses',
    multiAccountFeatureSend: 'Send up to 30 emails per day',
    premiumFeatureDomains: 'Domains for Genshin Impact, Honkai: Star Rail, Zenless Zone Zero, and Honkai Impact 3rd',
    premiumFeatureExclusiveDomain: 'Access to the exclusive mihoyo.email domain',
    premiumFeatureAccounts: 'Create up to 10 email addresses',
    premiumFeatureSend: 'Send up to 100 emails per day',
    upgradePayAmount: 'Upgrade price',
    recommended: 'Recommended',
    goToAfdian: 'Go to Afdian',
    analytics: 'Analytics',
    allUsers: 'All Users',
    allMail: 'All Mail',
    permissions: 'Role',
    ...
    loginEmailFullHint: 'Domains are hidden. Enter your full email address to sign in',
    registerEmailUsernameHint: 'Enter only a username to register {domain} automatically',
    registerEmailFullHint: 'Domains are hidden. Enter your full email address to register',
    ...
    allowedLoginDomains: 'Sign-in domains',
    allowedLoginDomainsDesc: 'Only email addresses under these domains can sign in. The administrator is exempt',
    allowedRegisterDomains: 'Registration domains',
    allowedRegisterDomainsDesc: 'Only these domains can be used to register new accounts',
