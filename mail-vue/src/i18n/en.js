const en = {
    ...
    settings: 'Settings',
    upgradeRole: 'Upgrade',
    upgradeRoleDesc: 'Permanent access; upgrades only charge the price difference',
    ...
    unionPay: 'UnionPay',
    jdPay: 'JD Pay',
    paymentSuccess: 'Payment succeeded and your role has been updated',
    paymentPending: 'The order is still being confirmed. Please refresh later',
    paymentConfirming: 'Payment returned. Confirming the order status',
    paymentReturnInvalid: 'Return signature verification failed. Checking the actual order status',
    analytics: 'Analytics',
    allUsers: 'All Users',
    allMail: 'All Mail',
    permissions: 'Role',
