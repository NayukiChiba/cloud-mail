const zh = {
    ...
    settings: '个人设置',
    upgradeRole: '升级权限',
    upgradeRoleDesc: '永久权限，升级只需支付等级差价',
    currentRole: '当前身份',
    currentPlan: '当前套餐',
    ...
    unionPay: '云闪付',
    jdPay: '京东支付',
    paymentSuccess: '支付成功，权限已更新',
    paymentPending: '订单仍在确认中，请稍后刷新页面',
    paymentConfirming: '支付已返回，正在确认订单状态',
    paymentReturnInvalid: '同步返回验签失败，正在查询实际订单状态',
    analytics: '分析页',
    allUsers: '用户列表',
    allMail: '全部邮件',
    permissions: '权限控制',
