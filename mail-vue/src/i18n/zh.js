const zh = {
    ...
    settings: '个人设置',
    upgradeRole: '升级权限',
    upgradeRoleDesc: '永久权限，前往爱发电支持后请联系管理员升级',
    currentRole: '当前身份',
    currentPlan: '当前套餐',
    cannotDowngrade: '不可降级',
    permanentRole: '永久有效',
    planHighlights: '套餐特点',
    multiDomainFeatureDomains: '支持原神、星穹铁道、绝区零、崩坏三域名',
    multiDomainFeatureAccounts: '每个域名可创建 1 个邮箱',
    multiDomainFeatureSend: '每日最多发送 20 封邮件',
    multiAccountFeatureDomains: '支持原神、星穹铁道、绝区零、崩坏三域名',
    multiAccountFeatureAccounts: '最多创建 10 个邮箱账户',
    multiAccountFeatureSend: '每日最多发送 30 封邮件',
    premiumFeatureDomains: '支持原神、星穹铁道、绝区零、崩坏三域名',
    premiumFeatureExclusiveDomain: '可使用“米哈游.email”专属域名',
    premiumFeatureAccounts: '最多创建 10 个邮箱账户',
    premiumFeatureSend: '每日最多发送 100 封邮件',
    upgradePayAmount: '升级应付',
    recommended: '推荐',
    goToAfdian: '前往爱发电',
    analytics: '分析页',
    allUsers: '用户列表',
    ...
    loginEmailUsernameHint: '只用用户名登录,不要加域名',
    loginEmailFullHint: '域名已隐藏，请输入完整邮箱地址登录',
    registerEmailUsernameHint: '只填写用户名，会自动注册{domain}',
    registerEmailFullHint: '域名已隐藏，请输入完整邮箱地址注册',
    confirmPwd: '确认密码',
    ...
    websiteReg: '用户注册',
    loginDomain: '隐藏登录域名',
    allowedLoginDomains: '允许登录的域名',
    allowedLoginDomainsDesc: '只有这些域名下的邮箱可以登录，管理员邮箱不受限制',
    allowedRegisterDomains: '允许注册的域名',
    allowedRegisterDomainsDesc: '只有这些域名可以注册新账号',
    multipleEmail: '多号模式',
