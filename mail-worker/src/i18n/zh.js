const zh = {
	...
	paymentNotConfigured: '支付接口尚未配置完整',
	paymentPlanNotExist: '支付套餐不存在',
	paymentTypeInvalid: '不支持该支付方式',
	paymentAdminNotRequired: '管理员无需购买权限',
	paymentCannotUpgrade: '只能升级到更高等级',
	paymentOrderNotExist: '支付订单不存在',
